<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard', ['default'])" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
            ...
            <!-- Hamburger -->
            <div class="-mr-2 flex items-center sm:hidden app-menu-mobile">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard', ['default'])" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
            ...
            <x-responsive-nav-link :href="route('clients.index')" :active="request()->routeIs('clientes.index')">
                {{ __('Clientes') }}
            </x-responsive-nav-link>
